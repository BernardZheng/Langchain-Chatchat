...
LastEditors: 郑龙
LastEditTime: 2024-08-09 15:43:52
FilePath: \libs\chatchat-server\chatchat\pages\simple.py
Description: 
'''
import sys
...
from chatchat.webui_pages.dialogue.simple_dialogue import  dialogue_page
...
if __name__ == "__main__":
    ...
    with st.sidebar:
        st.image(
            get_img_base64("tianma.png"), use_column_width=True
        )
        st.caption(
